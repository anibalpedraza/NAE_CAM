...
def main(DATA_ID, ATCK_NAME):
    ...
    if calculate_metrics == True:
        ...
        csvPath=fullfile('results','csv', DATA_ID+"_metrics.csv")
...
if __name__ == "__main__":
    ATCK_NAME_LIST =['CarliniL2Method','HopSkipJump','FastGradientMethod'
            'ProjectedGradientDescent','BoundaryAttack']
    # Old
